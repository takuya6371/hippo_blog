    ...
    <div style="height:110px;"></div>
      ...
      <div class="starter-template" v-if="content_mode === 'list'">
        ...
        <div class="card-deck">    
            ...
            <nuxt-link class="header_list" v-bind:to="{'path':'/page/page', 'query':{'id':post.permalink}}">
                <div class="card-body">
...
export default {
  ...
  asyncData: async ({ app, route, payload,store }) => {
    ...
    if(route.query.id == "outdoor" || route.query.id == "it" || route.query.id == "travel"){
      mode = "list"
      ...
      console.log("cont")
      mode = "content"
      page_data = await app.$content("").get(route.query.id)
    }
    let list_contents
    if(process.env.BASE_URL == 'http://localhost:3000'){
